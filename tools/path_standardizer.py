...
class PathStandardizer:
    ...
    def apply_standardization(self, dry_run: bool = False) -> List[str]:
        ...
        print(f"{'试运行' if dry_run else '正式运行'}路径标准化，将修改 {len(files_issues)} 个文件")
    ...
    def generate_report(self, output_file: str = None) -> str:
        ...
        if output_file is None:
            ...
            output_file = self.project_root / 'logs' / \
...
def main():
    ...
    if args.scan or args.report:
        ...
        # 应用标准化
        modified_files = standardizer.apply_standardization(
