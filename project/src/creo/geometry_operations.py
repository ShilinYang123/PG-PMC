...
class GeometryOperations:
    ...
    def create_cylinder(self, diameter: float, height: float, 
        ...
        try:
            ...
            self.logger.info(f"开始创建圆柱体: 直径{diameter}cm, 高度{height}cm, 材料{material}")
    ...
    def create_box(self, length: float, width: float, height: float,
        ...
        try:
            ...
            self.logger.info(f"开始创建长方体: {length}x{width}x{height}cm, 材料{material}")
    ...
    def create_sphere(self, diameter: float, material: str = "Steel",
                     position: Tuple[float, float, float] = (0, 0, 0)) -> bool:
        """创建球体
        ...
        try:
            ...
            self.logger.info(f"开始创建球体: 直径{diameter}cm, 材料{material}")
